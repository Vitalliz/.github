...
## Tema do Projeto - Aplicativo **NitrusLeaf** 🍊
...
- **`nitrusleaf-mobile` :** Aplicação mobile do projeto desenvolvida em React Native e TypeScript.
- **`nitrusleaf-web` :** Versão web do sistema NitrusLeaf.
- **`pi-artigo-fatec` :** Artigo científico, documentação e artefatos do projeto em Latex.
- **`apresentacao-nitrusleaf` :** Slides oficiais de apresentação do projeto em Latex Beamer.
- **`vitalliz-landing-page`**: Landing page institucional da equipe Vitalliz.
